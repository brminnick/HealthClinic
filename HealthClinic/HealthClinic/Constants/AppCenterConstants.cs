namespace HealthClinic
{
    public static class AppCenterConstants
    {
        ...
        public const string FoodListItemTapped = "Food List Item Tapped";
        public const string FoodListPageAppeared = "Food List Page Appeared";
        public const string NoCameraFound = "No Camera Found";
        public const string UploadPhotoFailed = "Upload Photo Failed";
