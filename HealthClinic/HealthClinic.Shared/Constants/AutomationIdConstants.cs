namespace HealthClinic.Shared
{
    ...
    {
        public const string FoodListPage_AddFoodButton = nameof(FoodListPage_AddFoodButton);
        public const string FoodListPage_FoodList = nameof(FoodListPage_FoodList);
